...
- Demo chatbot app: [https://ai-change-management.onrender.com](https://ai-change-management.onrender.com)
- Change management console: [https://ai-change-management.onrender.com/console](https://ai-change-management.onrender.com/console)

The 1st request after idle takes about a minute to wake. A free instance also loses its filesystem every time it sleeps, so the console re-seeds itself on each cold start from `[datasets/demo_seed.json](datasets/demo_seed.json)` — 2 real recorded benchmark runs, not fabricated rows; anything you add yourself lasts until the next sleep.
...
Github repo: [https://github.com/niufei8888/ai_change_management](https://github.com/niufei8888/ai_change_management)
...
1. **Two major problems: quick testing out ideas and benchmarking.** Modern AI application includes these 2 parts:

- **Platform codes**: orchestration engine and serving code
- **Domain context**: prompts, registered toolcalls, orchestration config, data (including knowledge base)  
